...
$(document).ready(function(){
	...
	post({'action':'getAllTemplates'}, function(resp){
		$.each(resp.templates, function(key, value){
			$('.template-manager').append('<tr id="'+value.ID+'"><td>'+value.ID+'</td><td>'+value.msg+'</td><td>'+value.created+'</td><td><i class="fa fa-plus plus"></i></td><td><i class="fa fa-trash delete"></i></td></tr>');
			// show more
