	...
	class Linkedin{
		...
		*/
		public function receiveMsg($msg){
			...
			if(getMsgReceived($this->_accountID, null, null, $msg['msg_id']) == null && $msg['by']!='bot'){
				...
				$watson = $prev['watson_context']??null;
		...
		*/ 
		...
		public function conversationExists($user_id){
			...
			return !($conv == null || !isset($conv->elements) || $conv->elements == array() || !isset($conv->elements[0]->totalEventCount) || $conv->elements[0]->totalEventCount <= 1);
		}
